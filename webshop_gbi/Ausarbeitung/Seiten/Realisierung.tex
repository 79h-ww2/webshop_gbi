...
\includegraphics[width=8cm]{Bilder/Abbildung5-StartseiteDesWebshops.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{Bilder/Abbildung6-ImpressumDesWebshops.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{Bilder/Abbildung7-AGBDesWebshops.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{Bilder/Abbildung8-DatenschutzDesWebshops.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{Bilder/Abbildung9-DynamischeNaviagtionDesWebshops.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{Bilder/Abbildung10-DynamischeArtikelauflistungAllerCitybikes.png}
\end{center}
...
\begin{center}
\fbox{
\includegraphics[width=8cm]{Bilder/Abbildung11-DynamischeDetailierteArtikelbeschreibung.png}}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=8cm]{Bilder/Abbildung12-DynamischeDetailierteArtikelbeschreibungFertig.png}
\end{center}
...
\begin{center}
\fbox{
\includegraphics[width=8cm]{Bilder/Abbildung14-StartseiteAngebotDesTages.png}
}
\end{center}
...
\subsection{Arbeitspakete von Herrn Brüntrup$^1$}
